...
# the backend (Kubernetes today; the earlier Docker-over-SSH driver was
# removed once ssh_docker was retired) can change without touching business
# logic. See /ROADMAP.md §3.1/§8 (ADR-2).
#
