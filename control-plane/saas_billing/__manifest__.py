...
Owns the payment-provider routing/gateway, wallet, support plans, the
sellable add-on catalog and the pricing engine, plus the commercial half
of `saas.instance` (invoicing, renewal, dunning, plan changes, add-on
purchases, margin) and of `saas.plan`, added via `_inherit`.
""",
